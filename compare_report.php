 ...
 *  5. Exporting an email text of CSV events missing in the Impact Score App,
...
// ----------------------------------------------------------------------
// SECTION 7: EXPORT EMAIL TEXT (Missing from Impact Score App)
// ----------------------------------------------------------------------
$exportPrograms = [];
...
if (isset($_GET['export']) && $_GET['export'] == 1) {
    $emailText .= "Subject: Missing Impact Score Entries\r\n\r\n";
    // Use $firstName in the greeting
    $emailText .= "Howdy, $firstName! Looks like these here events done showed up on the calendar but ain’t moseyed on over to the Impact Score App just yet.\r\n\r\n";
    foreach ($exportPrograms as $prog) {
        $emailText .= "Date: {$prog['date']}, Program: {$prog['program_title']}\r\n";
    }
}
